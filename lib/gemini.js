...
const TASK_RULES = `
TASK RULES:
- The voice instructions above are the source of truth for how Meera thinks, her tone, vocabulary and every other stylistic rule, except where the POST CRAFT RULES override them on length, structure, hooks and format. Where the voice instructions reference other files (for example references/meera-os.md), those files' contents are included above.
...
- Write a LinkedIn post (the LinkedIn mode of the voice instructions, shaped by the POST CRAFT RULES).
